...
import Breakfast from '../Resources/Images/breakfast.jpg';
import Lunch from '../Resources/Images/lunch.jpg';
import Dinner from '../Resources/Images/dinner.jpg';
import Dessert from '../Resources/Images/dessert.jpg';
const breakfast = [
    {
        id: 1,
            ...
            <div className='dessert bg-dark text-light py-5'>
                <div className='container'>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-lg-6 d-flex justify-content-center'>
                            <img src={Dessert} className='img-fluid w-75 mt-4 mt-lg-0' alt="" />
                        </div>
                    </div>
                </div>
            </div>
